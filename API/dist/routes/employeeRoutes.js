...
router.post('/', (0, authMiddleware_1.requirePermission)('employees', 'create'), uploadMiddleware_1.uploadProfilePhoto.single('profilePhoto'), employeeController_1.createEmployee);
