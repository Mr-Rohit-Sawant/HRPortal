...
export declare const toggleRole: (req: Request, res: Response) => Promise<void>;
...
export declare const uploadCustomFieldFiles: (req: Request, res: Response) => Promise<void>;
