...
async function main() {
    ...
    const passwordHash = await bcryptjs_1.default.hash('SuperAdmin@123', 12);
    ...
    const cvColumns = [
        { module: 'cv', name: 'status', label: 'Status', dataType: 'STATUS', order: 1, isVisible: true },
        { module: 'cv', name: 'priority', label: 'Priority', dataType: 'PRIORITY', order: 2, isVisible: true },
        { module: 'cv', name: 'current_location', label: 'Location', dataType: 'LOCATION', order: 3, isVisible: true },
        { module: 'cv', name: 'current_ctc', label: 'Current CTC', dataType: 'NUMBER', order: 4, isVisible: true },
        { module: 'cv', name: 'expected_ctc', label: 'Expected CTC', dataType: 'NUMBER', order: 5, isVisible: true },
        { module: 'cv', name: 'notice_period', label: 'Notice Period', dataType: 'NUMBER', order: 6, isVisible: true },
        { module: 'cv', name: 'total_experience', label: 'Experience', dataType: 'NUMBER', order: 7, isVisible: true },
    ];
    ...
    const jobColumns = [
        { module: 'jobs', name: 'status', label: 'Status', dataType: 'STATUS', order: 1, isVisible: true },
        { module: 'jobs', name: 'priority', label: 'Priority', dataType: 'PRIORITY', order: 2, isVisible: true },
        { module: 'jobs', name: 'work_location', label: 'Location', dataType: 'LOCATION', order: 3, isVisible: true },
        { module: 'jobs', name: 'assigned_employees', label: 'Assigned To', dataType: 'EMPLOYEE', order: 4, isVisible: true },
        { module: 'jobs', name: 'candidates', label: 'Candidates', dataType: 'CANDIDATES', order: 5, isVisible: true },
        { module: 'jobs', name: 'closing_date', label: 'Closing Date', dataType: 'DATE', order: 6, isVisible: true },
    ];
